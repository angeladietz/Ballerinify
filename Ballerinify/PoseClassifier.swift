...
//    }
    ...
    func isArmsThirdPos() -> Bool {
        if isArmSecond(side: Side.LEFT) && isArmFirst(side: Side.RIGHT) || isArmSecond(side: Side.RIGHT) && isArmFirst(side: Side.LEFT) {
            return true
        }
        return false
    }
    ...
    func isArmsFourthPos() -> Bool {
        if isArmSecond(side: Side.LEFT) && isArmFifth(side: Side.RIGHT) || isArmSecond(side: Side.RIGHT) && isArmFifth(side: Side.LEFT) {
            return true
        }
        return false
    }
